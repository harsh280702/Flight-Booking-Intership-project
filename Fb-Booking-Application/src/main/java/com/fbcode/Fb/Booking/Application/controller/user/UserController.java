...
public class UserController {
    ...
    public  Mono<ResponseEntity<UserEntityDto>> updateUser(@PathVariable("id") Long id ,   @RequestBody UserEntity  userEntity) {
        ...
        return userServices.updateUser(id,userEntity)
                ...
                .onErrorResume(throwable -> Mono.just(ResponseEntity.status(HttpStatus.NO_CONTENT).body(null)));
    ...
    public Mono<ResponseEntity<String>> deleteUser(@PathVariable("id") Long id ){
        ...
        return userServices.deleteUser(id)
                ...
                .onErrorResume(throwable -> Mono.just(ResponseEntity.status(HttpStatus.NO_CONTENT).body(userResponseDTO.getMessage())));
    }
    ...
    public Mono<ResponseEntity<String>> Logout(@PathVariable("logout") String token ){
        ...
        return userServices.Logout(token)
                ...
                .onErrorResume(throwable -> Mono.just(ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(null)));
    ...
    @GetMapping("")
    public Mono<ResponseEntity<UserEntityDto>> getUserByUserName(@PathVariable("email") String username){
        UserResponseDTO userResponseDTO =  new UserResponseDTO();
